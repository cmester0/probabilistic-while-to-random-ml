...
\section{Theory and existing frameworks (2 TODOS LEFT)} 
\label{sec:theory}
% Goal: 6-12 pages
...
The $f$ in function application can be a \todo{cite}``primitive or a user-defined
...
\section{Our approach (2 TODOS LEFT)}\label{sec:approach}
% Goal: 6-12 pages
...
\section{Our contribution (READY)}\label{sec:contrib}
% Goal: 6-12 pages
