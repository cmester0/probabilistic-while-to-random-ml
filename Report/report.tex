...
% A measure is a linear function µ from a set A to non-negative real numbers. It also
% preserves least upper bounds.
% Our set is the functions of a base-type to [0,1]. We write Mß for a measure on the
% type ß.

% Mß = (ß->[0,1])->[0,1]
% The (ß->[0,1]) part describes a probability distribution. With this input we can
% compute a new probability distribution in our programs. 
