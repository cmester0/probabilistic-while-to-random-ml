...
\begin{center}
  \resizebox{1.05\linewidth}{!}{
    \begin{tabular}{|c|c|c|}
      ...
      sFix $T$ $f$ $x$ $e_1'$ $e_2'$ & $(Y~(\lambda f : T \rightarrow S, \lambda x : T, e_1 : S) : T \rightarrow S)~(e_2 : T) : S$ & $(\backslash f \rightarrow e_2) (\backslash x \rightarrow \mathtt{dlim}~(\mathtt{ubn}~e_1~x))$ \\ \hline
    \end{tabular}
  }
\end{center}
